...
public class SendOwnerInviteCommandHandler : IRequestHandler<SendOwnerInviteCommand, MessageResponseDto>
{
    ...
    public async Task<MessageResponseDto> Handle(SendOwnerInviteCommand command, CancellationToken cancellationToken)
    {
        ...
        var subject = $"Invitation to join MoveWell from {clinic.ClinicName}";
        var body = $"""
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1e293b;">
                <h2 style="color: #1e3a8a;">Welcome to MoveWell!</h2>
                <p>Hello {recipientGreeting},</p>
                <p><strong>{physioUser.FirstName} {physioUser.LastName}</strong> from <strong>{clinic.ClinicName}</strong> has invited you to create your MoveWell Companion account to manage your pet's rehabilitation and home exercise plans.</p>
                ...
                <p>Enter this code when signing up in the MoveWell mobile app or use the link below to get started:</p>
